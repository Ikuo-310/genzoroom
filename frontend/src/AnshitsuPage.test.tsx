...
describe('Anshitsu workspace', () => {
  ...
  it('renders adjustment, category, and reset History succinctly in newest-first order', () => {
    const contrast: EditEntry = {
      kind: 'contrast',
      before: { version: 14, whiteBalanceEnabled: true, basicEnabled: true, colorGradingEnabled: true, colorEnabled: true, adjustments: { temperature: 0, tint: 0, exposure: 0.25, contrast: 0, highlights: 0, whites: 0, shadows: 0, blacks: 0, shadowsTemperature: 0, shadowsTint: 0, midtonesTemperature: 0, midtonesTint: 0, vibrance: 0, saturation: 0 } },
      after: { version: 14, whiteBalanceEnabled: true, basicEnabled: true, colorGradingEnabled: true, colorEnabled: true, adjustments: { temperature: 0, tint: 0, exposure: 0.25, contrast: 30, highlights: 0, whites: 0, shadows: 0, blacks: 0, shadowsTemperature: 0, shadowsTint: 0, midtonesTemperature: 0, midtonesTint: 0, vibrance: 0, saturation: 0 } },
    };
    const highlights: EditEntry = {
      kind: 'highlights',
      before: contrast.after,
      after: { version: 14, whiteBalanceEnabled: true, basicEnabled: true, colorGradingEnabled: true, colorEnabled: true, adjustments: { temperature: 0, tint: 0, exposure: 0.25, contrast: 30, highlights: -20, whites: 0, shadows: 0, blacks: 0, shadowsTemperature: 0, shadowsTint: 0, midtonesTemperature: 0, midtonesTint: 0, vibrance: 0, saturation: 0 } },
    };
    const whites: EditEntry = {
      kind: 'whites',
      before: highlights.after,
      after: { version: 14, whiteBalanceEnabled: true, basicEnabled: true, colorGradingEnabled: true, colorEnabled: true, adjustments: { temperature: 0, tint: 0, exposure: 0.25, contrast: 30, highlights: -20, whites: 15, shadows: 0, blacks: 0, shadowsTemperature: 0, shadowsTint: 0, midtonesTemperature: 0, midtonesTint: 0, vibrance: 0, saturation: 0 } },
    };
    const shadows: EditEntry = {
      kind: 'shadows',
      before: whites.after,
      after: { version: 14, whiteBalanceEnabled: true, basicEnabled: true, colorGradingEnabled: true, colorEnabled: true, adjustments: { temperature: 0, tint: 0, exposure: 0.25, contrast: 30, highlights: -20, whites: 15, shadows: 25, blacks: 0, shadowsTemperature: 0, shadowsTint: 0, midtonesTemperature: 0, midtonesTint: 0, vibrance: 0, saturation: 0 } },
    };
    const blacks: EditEntry = {
      kind: 'blacks',
      before: shadows.after,
      after: { version: 14, whiteBalanceEnabled: true, basicEnabled: true, colorGradingEnabled: true, colorEnabled: true, adjustments: { temperature: 0, tint: 0, exposure: 0.25, contrast: 30, highlights: -20, whites: 15, shadows: 25, blacks: -35, shadowsTemperature: 0, shadowsTint: 0, midtonesTemperature: 0, midtonesTint: 0, vibrance: 0, saturation: 0 } },
    };
    const allReset: EditEntry = {
      kind: 'allReset',
      before: { ...blacks.after, basicEnabled: false },
      after: { version: 14, whiteBalanceEnabled: true, basicEnabled: true, colorGradingEnabled: true, colorEnabled: true, adjustments: { temperature: 0, tint: 0, exposure: 0, contrast: 0, highlights: 0, whites: 0, shadows: 0, blacks: 0, shadowsTemperature: 0, shadowsTint: 0, midtonesTemperature: 0, midtonesTint: 0, vibrance: 0, saturation: 0 } },
    };
    ...
    const basicReset: EditEntry = {
      ...
      after: { version: 14, whiteBalanceEnabled: true, basicEnabled: false, colorGradingEnabled: true, colorEnabled: true, adjustments: { temperature: 0, tint: 0, exposure: 0, contrast: 0, highlights: 0, whites: 0, shadows: 0, blacks: 0, shadowsTemperature: 0, shadowsTint: 0, midtonesTemperature: 0, midtonesTint: 0, vibrance: 0, saturation: 0 } },
    };
  ...
  it('renders Basic ON after an enable operation', () => {
    const before = { version: 14, whiteBalanceEnabled: true, basicEnabled: false, colorGradingEnabled: true, colorEnabled: true, adjustments: { temperature: 0, tint: 0, exposure: 0.25, contrast: 20, highlights: -30, whites: 10, shadows: 40, blacks: -15, shadowsTemperature: 0, shadowsTint: 0, midtonesTemperature: 0, midtonesTint: 0, vibrance: 0, saturation: 0 } } as const;
...
function historyEntry(before: number, after: number): EditEntry {
  return {
    kind: 'exposure',
    before: { version: 14, whiteBalanceEnabled: true, basicEnabled: true, colorGradingEnabled: true, colorEnabled: true, adjustments: { temperature: 0, tint: 0, exposure: before, contrast: 0, highlights: 0, whites: 0, shadows: 0, blacks: 0, shadowsTemperature: 0, shadowsTint: 0, midtonesTemperature: 0, midtonesTint: 0, vibrance: 0, saturation: 0 } },
    after: { version: 14, whiteBalanceEnabled: true, basicEnabled: true, colorGradingEnabled: true, colorEnabled: true, adjustments: { temperature: 0, tint: 0, exposure: after, contrast: 0, highlights: 0, whites: 0, shadows: 0, blacks: 0, shadowsTemperature: 0, shadowsTint: 0, midtonesTemperature: 0, midtonesTint: 0, vibrance: 0, saturation: 0 } },
  };
}
