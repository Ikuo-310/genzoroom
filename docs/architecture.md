...
Temporary Immich preview adapter (editImageSource.ts)
  ...
  → result buffer transferred to AdjustedImage.tsx → Canvas preview → existing Viewer transforms
```
