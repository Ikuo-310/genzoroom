...
**Status: Early Development — Immich browsing and minimal JPEG Exposure/Contrast adjustments are available. RAW development is not implemented.**
...
- Non-destructive JPEG Exposure and Contrast adjustments with compact slider/direct-value controls, per-asset in-memory recipes, grouped Undo/Redo and History, individual resets, and All Reset. This initial version uses Immich previews as a temporary input.
...
- HEIC adjustments and JPEG adjustments other than Exposure and Contrast.
- RAW development.
