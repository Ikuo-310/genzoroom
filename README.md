...
**Status: Early Development — Immich browsing and minimal JPEG Temperature/Tint/Exposure/Contrast/Highlights/Whites/Shadows/Blacks adjustments are available. RAW development is not implemented.**
...
- Non-destructive JPEG Temperature (−100 warm to +100 cool) and Tint (−100 green to +100 magenta), both integer steps with default 0, in a White Balance category above Basic. Each has a directional gradient track. Both categories have independent collapse, bypass, and reset controls.
...
- HEIC adjustments and JPEG adjustments other than Temperature, Tint, Exposure, Contrast, Highlights, Whites, Shadows, and Blacks.
- RAW development.
